...
<?php
if($_POST['set'] == "Layered Arch" && $month === '01') {
    echo 'Sorry, the Layered Arch set is unavailable in January. Please select another set.';
    echo '<br>';
    echo( "<button onclick= \"location.href='https://blueteam2022.greenriverdev.com/Wedding_Website_Sprint_2/Sets.php'\">Back To Sets </button>");
}
elseif ($_POST['set'] == "Layered Arch") {
    ?>
    <style type="text/css">
        #layeredArch {
            display: block;
...
if($_POST['set'] == "Modern Round" && $month === '02') {
    echo 'Sorry, the Modern Round set is unavailable in February. Please select another set.';
    echo '<br>';
    echo( "<button onclick= \"location.href='https://blueteam2022.greenriverdev.com/Wedding_Website_Sprint_2/Sets.php'\">Back To Sets </button>");
}
...
<?php }
if($_POST['set'] == "Vintage Mirror" && $month === '03') {
    echo 'Sorry, the Vintage Mirror set is unavailable in March. Please select another set.';
    echo '<br>';
    echo( "<button onclick= \"location.href='https://blueteam2022.greenriverdev.com/Wedding_Website_Sprint_2/Sets.php'\">Back To Sets </button>");
}
...
<?php }
if($_POST['set'] == "Dark Walnut" && $month === '04') {
    echo 'Sorry, the Dark Walnut set is unavailable in April. Please select another set.';
    echo '<br>';
    echo( "<button onclick= \"location.href='https://blueteam2022.greenriverdev.com/Wedding_Website_Sprint_2/Sets.php'\">Back To Sets </button>");
}
...
<?php }
if($_POST['set'] == "Rustic Wood" && $month == '05') {
    echo 'Sorry, the Rustic Wood set is unavailable in May. Please select another set.';
    echo '<br>';
    echo( "<button onclick= \"location.href='https://blueteam2022.greenriverdev.com/Wedding_Website_Sprint_2/Sets.php'\">Back To Sets </button>");
}
